...
var instructions_01 = {
  ...
  pages: [
    ...
    '<p>Try to be as fast and as accurate as you can be.</p><p>If you cannot solve the puzzle then you should guess - you will not be penalised for an incorrect answer.</p><p>The task contains a shuffled mix of easy, medium and hard puzzles.</p><p>You will have <b>30 seconds</b> to complete each puzzle.</p>',
...
var instructions_02 = {
  ...
  pages: [
    ...
    '<p>Now, we will move onto the real puzzles.</p>You will have <b>8 minutes</b> to complete as many puzzles as possible.</p><p>Try to be as fast and as accurate as you can be.</p><p>Press the "next" button to get started.</p>'
  ],
  show_clickable_nav: true,
  button_label_previous: 'Prev',
  button_label_next: 'Next',
...
for (let i = 0; i < 3; i++) {
  ...
  const practice_trial = {
    type: 'mars',
    stimulus: `../static/img/practice/pt${i+1}_M1.png`,
    choices: [

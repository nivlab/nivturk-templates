...
jsPsych.plugins["symmetry-judgement-task"] = (function () {
  ...
  plugin.trial = function (display_element, trial) {
    ...
    for (i = 0; i < blackBoxesFinal.length; i++) {
      paper.innerHTML += '<img src="../static/img/blackbox.png" style="position: absolute; top:' + blackBoxesFinal[i][0] * (trial.size_cells - 2) + 'px; left:' + blackBoxesFinal[i][1] * (trial.size_cells - 2) + 'px; width:' + trial.size_cells + 'px; height:' + trial.size_cells + 'px;"></img>';
    }
